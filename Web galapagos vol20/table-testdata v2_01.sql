...
-- テーブル名：M80担当者
/* ------------------------------------- */
INSERT INTO M80担当者(担当CD,担当名,ログインCD,権限CD) VALUES ('9999','管理者','00100ADMIN010',9)
INSERT INTO M80担当者(担当CD,担当名,ログインCD,権限CD) VALUES ('300','出庫入庫担当者','00100LEADER10',3)
INSERT INTO M80担当者(担当CD,担当名,ログインCD,権限CD) VALUES ('100','出庫担当者','00100STAFF010',1)
...
-- テーブル名：MA0画面制御
/* ------------------------------------- */
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('1010','出庫','#FF45A0 ','#000000','parent.top.location.href=''../eh10/eh1010.asp?fnc=add''',1)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('1020','入庫','#C0C0C0','#000000','parent.top.location.href=''../eh10/eh1020.asp?fnc=add''',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('1030','在庫一覧','#666699 ','#000000','parent.top.location.href=''../eh10/eh1030.asp''',1)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('103U','在庫一覧','#666699 ','#000000','',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('1050','出庫履歴','#FF45A0   ','#FFFFFF','parent.top.location.href=''../eh10/eh1050.asp''',1)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('105U','出庫履歴','#FF45A0   ','#FFFFFF','',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('1060','入庫履歴','#1E90FF  ','#FFFFFF','parent.top.location.href=''../eh10/eh1060.asp''',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('106U','入庫履歴','#1E90FF  ','#FFFFFF','',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('1090','アイテム管理','#FF4500','#000000','parent.top.location.href=''../eh10/eh1090.asp''',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('109U','アイテム','#FF4500','#000000','',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('10A0','アイテム発注','#FF4500','#000000','parent.top.location.href=''../eh10/eh10A0.asp''',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('10AU','アイテム発注','#FF4500','#000000','',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('10B0','出庫集計','#FF4500','#000000','parent.top.location.href=''../eh10/eh10B0.asp''',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('10BU','出庫集計','#FF4500','#000000','',3)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('10W0','担当者ﾏｽﾀ登録更新','#FF4500','#000000','parent.top.location.href=''../eh10/eh10W0.asp''',9)
INSERT INTO MA0画面制御(画面番号,画面名称,背景色,文字色,実行pro,権限LV) VALUES ('10Y0','共通ﾏｽﾀ登録更新','#FF4500','#000000','parent.top.location.href=''../eh10/eh10Y0.asp''',9)

...
<%= Rq_GamenNm %> 検索
	...
	<div class="search">
		<INPUT TYPE="TEXT" NAME="Rq_ew" SIZE="4" MAXLENGTH="50" VALUE="<%= Rq_ew %>" style="font-size: 30px;">
...
sqlselect	= "* "
sqlfrom		= "M70ITEM "
sqlwhere	= "削除FLG=0 And LEN(アイテム棚番号)>0 "
...
%>
		...
		With Response
		 If Not rsSql.EOF Then
			...
			.Write "<TR >"
			.Write "<TH NOWRAP width=""290"">アイテム名</TH>" 
			.Write "<TH NOWRAP width=""55"">在庫数</TH>" 
			.Write "<TH NOWRAP width=""120"">棚番号</TH>" 
			.Write "</TR>"
...
SUB fnc_SearchSet()
	...
	If Rq_ew<>"" Then
		...
		sqlwhere = sqlwhere + " AND "
			...
			sqlwhere = sqlwhere + "アイテムCD+アイテム名 Like N'%"+vntArray(i) +"%' AND アイテム棚番号 Like N'%"+Rq_TanaCd +"%'" 
		Next
	End If
